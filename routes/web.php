    ...
    Route::namespace('Authenticated')->group(function(){
        ...
        Route::namespace('Calendar')->group(function(){
            ...
            Route::namespace('Admin')->group(function(){
                ...
                Route::get('/calendar/{date}/{part}', 'CalendarsController@reserveDetail')->name('calendar.admin.detail'); // 予約詳細
        ...
        Route::namespace('BulletinBoard')->group(function(){
            ...
            Route::get('/bulletin_board/delete/{id}', 'PostsController@postDelete')->name('post.delete'); // 投稿削除
