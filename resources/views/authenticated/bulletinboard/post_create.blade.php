...
<div class="post_create_container d-flex">
  <div class="post_create_area border w-50 m-5 p-5">
    <div class="">
      ...
      <select class="w-100" form="postCreate" name="post_category_id"><!--name="post_category_id"-->
  ...
  <div class="w-25 ml-auto mr-auto">
    <div class="category_area mt-5 p-5">
      ...
      <div class="">
        ...
        <select class="w-100" name="main_category_id" form="subCategoryRequest"><!-- select(プルダウンメニュー) --><!--name="main_category_name"-->
          <option>---</option>
          @foreach($main_categories as $main_category)
