...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'main_category_name' => [
         'required' => 'メインカテゴリーは必ず入力してください。',
         'max' => 'メインカテゴリーは100文字以内で入力してください。',
         'unique' => '既に登録されているメインカテゴリーです。',
        ],

        'main_category_id' => [
         'exists' => 'メインカテゴリーを選択してください。',
        ],

        'sub_category_name' => [
         'required' => 'サブカテゴリーは必ず入力してください。',
         'max' => 'サブカテゴリーは100文字以内で入力してください。',
         'unique' => '既に登録されているサブカテゴリーです。',
        ],
